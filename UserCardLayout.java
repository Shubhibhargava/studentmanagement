...
public class UserCardLayout extends JDialog implements ActionListener,ItemListener
{
JButton btedit,btdelete,btview,btclose;
JPanel pn,pmain;
CardLayout CLO;
public UserCardLayout()
{
	...
	CLO=new CardLayout();
	pmain.setLayout(CLO);
	pmain.add("View", new Viewallusers());
	pmain.add("Edit", new Edituserdetails());
	pmain.add("Delete", new DeleteUser());
	//pmain.add("Close", new LoginasAdmin());
